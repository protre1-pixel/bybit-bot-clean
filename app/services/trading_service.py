...
PROFIT_LOCK_RATIO = 0.8  # 2026-08-21: 사용자 요청 - 지금 장(상승 추세)이 좋아서 20% 반납쿠션을
# 줘서 트레일링을 더 태워보는 실거래 실험. 백테스트(4코인 순수 ratio 스윕, ratio07/09/10)에서는
# 0.7/0.9 둘 다 1.0보다 PF/MDD 열세였음 - 실거래 결과 보고 재조정 가능.
